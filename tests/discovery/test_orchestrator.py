...
class TestClaudeFileDiscovery:
    ...
    def test_discover_new_repositories_no_candidates(self, discovery):
        ...
        with patch.object(
            discovery.github_searcher, "search_github_repos", return_value=[]
        ):
            with patch.object(
    ...
    def test_discover_new_repositories_multiple_candidates(self, discovery):
        ...
        with patch.object(
            ...
            with patch.object(
                discovery.evaluator, "evaluate_candidate", side_effect=mock_evaluations
            ):
                with patch.object(
                    discovery.issue_generator,
                    "create_discovery_issue",
