...
class TestIssueFormatter:
    ...
    def test_create_issue_title_no_high_priority(self, issue_formatter):
        """Test creating issue title with no high priority candidates."""
        evaluations = [
            {'score': 5},
            {'score': 3},
        ]
    ...
    def test_create_issue_title_with_high_priority(self, issue_formatter):
        """Test creating issue title with high priority candidates."""
        evaluations = [
            {'score': 8},
            {'score': 5},
            {'score': 9},
    ...
    def test_create_issue_body_only_low_priority(self, issue_formatter):
        """Test creating issue body with only low priority evaluations."""
        evaluations = [
            {
                'score': 2,
                'candidate': {
                    ...
                    'description': 'Low priority repository',
                    'stars': 20,
                    'language': 'Python',
                    'topics': ['test'],
                    'claude_file_path': 'claude.md'
