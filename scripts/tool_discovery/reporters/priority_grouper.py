"""Priority grouper for organizing tool evaluations by score."""

from typing import Any


class ToolPriorityGrouper:
    """Groups tool evaluations by priority based on scores."""

    def __init__(self):
        # Thresholds for 100-point tool scoring system
        self.high_threshold = 80  # Exceptional
        self.medium_threshold = 65  # High Quality
        self.low_threshold = 50  # Good Quality (minimum acceptance)
