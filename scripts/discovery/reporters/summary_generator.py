...
class SummaryGenerator:
    ...
    def generate_summary_section(self, counts: dict[str, int]) -> str:
        ...
        summary_lines = [
            ...
            f"- **Exceptional** (≥85 points): {counts['exceptional']}",
            f"- **High** (70-84 points): {counts['high']}",
            f"- **Good** (60-69 points): {counts['good']}",
            f"- **Below Threshold** (<60 points): {counts['below_threshold']}",
            "",
        ]
        return "\n".join(summary_lines)
